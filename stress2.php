...
<div id=sudoku>
	<table border=0>
		<tr><td>
				...
				<center><h3 class=sudoku>rozwiaz sudoku jak najszybciej!</h3></center>
				<? if ($evaluate == "True") {
		...
		<tr><td>
				...
				<center><form method=post id="sudokuform" name="sudokuform">
						...
						<br><br><label style="font-size : 18px; width: 50%; height: 150px;">Twoj nick dokladnie ten z pierwszego testu!:</label><br><br>
