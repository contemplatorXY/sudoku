...
<table border=0>
<tr><td>
<center><h1 class=sudoku>spróbuj rozwiązać sudoku tak szybko jak potrafisz :)</h1></center>
</td></tr>
<tr><td><center>
...
<nobr><input type="button" value="L�sung zeigen" onclick="solveMySudoku()">
<input type="button" value="Pr�fung" onclick="checkMySudoku()">
